...
if __name__ == "__main__":
    src_directory = '/home/projects/bagon/andreyg/Projects/Object_reps_neural/Programming/detr/EXPERIMENTS/generate_detection_videos_and_meshes/videos_processed'  # <-- Replace this path
